...
const allExtensions = _objectSpread(_objectSpread(_objectSpread({}, _substrate.substrate), _shell.shell), _polkadot.polkadot); // the v4 signed extensions (the order is important here, as applied by default)
